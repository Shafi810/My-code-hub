...
useEffect(() => {
  ...
  />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        <h1 className="block text-3xl sm:text-6xl lg:text-7xl
        ...
        <div className="flex justify-center items-center">
          ...
          >
            Clean, modern, and user-friendly websites tailored to your business needs.
            
            <span className=" text-neutral-500 " role="alert">
            ⚠️ I do not accept adult or inappropriate projects — I focus on meaningful, impactful websites.
            </span>
            </p>
        ...
        <button className="relative inline-flex justify-center items-center px-8 py-4 mt-6 text-lg font-semibold 
  ...
  <a className="relative z-10 flex items-center"
      ...
      rel="noopener noreferrer">
       Hire Me on Fiverr<AnimatedDots />
      </a>
