...
function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      className="absolute bottom-0  right-6 z-50 flex items-center justify-center 
                 w-12 h-12 md:w-12 md:h-12 rounded-full border-2 border-blue-800 
                 text-blue-800 hover:bg-blue-800 hover:text-white transition-all duration-300 
...
const Footer = () => {
  return (
    <footer className="full-width-footer mt-20 border-t border-neutral-800 bg-neutral-950 text-neutral-300">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 px-6 sm:px-8 md:px-10 lg:px-16 py-6">
        <div>
        ...
        <div className="col-md-4 mb-3">
          ...
          <ul className="list-none text-gray-400">
            <li><strong>Name:</strong> Shafi Usmani</li>
            <li><strong>Phone:</strong> +92 309 1183431</li>
            <li><strong>Email:</strong> shafek790@gmail.com</li>
      ...
      <div className="flex justify-center gap-6 mt-5">
        ...
        >
          <div className="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center opacity-80 hover:scale-110 transition duration-200">
            <img src={fiver} alt="fiverr logo" className="w-8 h-8 object-contain" loading="lazy" />
          </div>
        </a>
